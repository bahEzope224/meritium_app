...
const AuthProvider = ({ children }) => {
  ...
  const logout = () => {
    ...
    localStorage.removeItem('meritium_token');
  };
...
<h1 className="text-2xl sm:text-3xl font-bold">Meritium</h1>   <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-4">
